...
void AGameDCharacter::UpdateAnimation()
{
...
void AGameDCharacter::Tick(float DeltaSeconds)
{
...
void AGameDCharacter::TouchStarted(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	// Jump on any touch
	Jump();
}

void AGameDCharacter::TouchStopped(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	// Cease jumping once touch stopped
	StopJumping();
}

void AGameDCharacter::UpdateCharacter()
{
